...
router.get('/', async (req, res) => {
  try {
    ...
    res.status(500).render('error', { title: 'Error', code: 500, message: 'Could not load admin panel.' });
  }
});
...
router.get('/users', async (req, res) => {
  try {
    ...
    res.status(500).render('error', { title: 'Error', code: 500, message: 'Could not load users.' });
  }
});
...
router.get('/payments', async (req, res) => {
  try {
    ...
    res.status(500).render('error', { title: 'Error', code: 500, message: 'Could not load payments.' });
  }
});
...
router.get('/plans', async (req, res) => {
  try {
    ...
    res.status(500).render('error', { title: 'Error', code: 500, message: 'Could not load plans.' });
  }
});
